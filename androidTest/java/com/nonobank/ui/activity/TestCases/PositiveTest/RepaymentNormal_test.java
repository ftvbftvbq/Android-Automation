...
/**
 * Created by edison on 16/8/11.
 */
public class RepaymentNormal_test extends ActivityInstrumentationTestCase2<HomeActivity> {
    private Solo solo;
    ...
    public void test_CSYYWithdraw () throws Exception {
        ...
        Logger.configLog("MXD_RepaymentNormal_log4j.log");
        ReadExcel TestData = new ReadExcel();
        TestData.getTestDataFile("/storage/emulated/0/mxdRepaymentNormalTestData.csv");
