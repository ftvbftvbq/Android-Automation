 ...
 */
public class FallbackTail_test extends ActivityInstrumentationTestCase2<HomeActivity> {
    private Solo solo;
    ...
    public void test_FallbackTail() throws Exception {
        LogUtil Logger = new LogUtil();
        Logger.configLog("MXD_FallbackTail_log4j.log");
        ...
        for (int i = 1; i < TestData.rowCount; i++) {
            ...
            sqlu.UpdateInborrowsArchive("update borrows_archive set is_audit=4 where bo_id="+sqlu.id);
            String SQL = "insert into admin_work_remark (am_id, am_id_to, status, remark_type, parent_id, title, refuse_reason, content,remark_aim, bo_id) values (5, 0,0, 5, 0, '初审回退',6, '好友联系电话中存在电话无效情况，如非还款逾期无法联系，我们不会随意联系。', " + sqlu.userId + "," + sqlu.id + ")";
        ...
        TestData.writeResults(TestResults, "mxdFallbackTailTestResult.txt");
    }
