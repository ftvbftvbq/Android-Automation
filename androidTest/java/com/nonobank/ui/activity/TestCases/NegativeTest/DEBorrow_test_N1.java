 ...
 */
public class DEBorrow_test_N1 extends ActivityInstrumentationTestCase2<HomeActivity> {
    private Solo solo;
    ...
    public void test_DEBorrow_test_N1() {
        LogUtil Logger = new LogUtil();
        Logger.configLog("mxdDEBorrowN1_log4j.log");

        ReadExcel TestData = new ReadExcel();
        TestData.getTestDataFile("/storage/emulated/0/mxdDEBorrowN1TestData.csv");
        ...
        for(int i =1; i<TestData.rowCount; i++) {
            ...
            Logger.gLogger.debug("点击判断大额借异常与否");
        ...
        TestData.writeResults(TestResults, "mxdDEBorrowN1TestResult.txt");
    }
