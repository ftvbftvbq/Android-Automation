 ...
 */
public class Login_test_N1 extends ActivityInstrumentationTestCase2<CheckLoginActivity> {
    private Solo solo;
    ...
    public void test_Login_test_N1() {
        LogUtil Logger = new LogUtil();
        Logger.configLog("mxdLoginN1_log4j.log");

        ReadExcel TestData = new ReadExcel();
        TestData.getTestDataFile("/storage/emulated/0/mxdLoginN1TestData.csv");
        ...
        TestData.writeResults(TestResults, "mxdLoginN1TestResult.txt");
    }
